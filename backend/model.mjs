...
// const getKanjiById = async (_id, jlpt) => {
//     switch (jlpt) {
//         case 1: 
//             const query1 = n1.findById( {_id: _id} );
//             return query1.exec();
//         case 2:
//             const query2 = n2.findById( {_id: _id} );
//             return query2.exec();
//         case 3:
//             const query3 = n3.findById( {_id: _id} );
//             return query3.exec();
//         case 4:
//             const query4 = n4.findById( {_id: _id} );
//             return query4.exec();
//         case 5:
//             const query5 = n5.findById( {_id: _id} );
//             return query5.exec();
//     }
// }
